...
const WorkspacePlan = () => {
  return (
    <section
      className="workspace-plan-section hosting-plans-section pt-100 pb-100"
      id="pricing"
    >
      <div className="container">
        ...
        <div className="row justify-content-center mt-20 mb-50">
          <div className="col-xl-12 col-lg-12 col-md-12 col-12">
            ...
            >
              <div className="workspace-include-list">
              ...
              <div className="workspace-include-list">
                <Image src={geminiIcon} alt="Gemini" />
              </div>
              <div className="workspace-include-list">
                <Image src={docsIcon} alt="Docs" />
              </div>
              <div className="workspace-include-list">
                <Image src={sheetsIcon} alt="Sheets" />
              </div>
              <div className="workspace-include-list">
                <Image src={slidesIcon} alt="Slides" />
              </div>
              <div className="workspace-include-list">
                <Image src={vidsIcon} alt="Vids" />
              </div>
              <div className="workspace-include-list">
                <Image src={keepIcon} alt="Keep" />
              </div>
              <div className="workspace-include-list">
                <Image src={sitesIcon} alt="Sites" />
              </div>
              <div className="workspace-include-list">
                <Image src={formsIcon} alt="Forms" />
              </div>
            </div>
          </div>
        </div>
        <div
          className="row gx-4 aos-init aos-animate"
          data-aos="fade-up"
          data-aos-easing="linear"
            ...
            <div className="plan-box workspace-height d-flex flex-column justify-content-between">
              <div className="">
                <div className="best-value">
                  <h3 className="div-text mb-0 weight-Regular">
                    Business Starter
                  </h3>
                ...
                <div className="plans-details">
                  ...
                  <div className="gst-bg">
                    <p className="small-text renews">GST 18% Additional</p>
                  </div>
              ...
              <div>
                ...
                <div className="plans-details">
                  ...
                  <ul className="plans-details-list">
                    ...
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />2 TB cloud
                      storage per user
                    </li>
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
            ...
            <div className="plan-box workspace-height d-flex flex-column justify-content-between">
              <div>
                <div className="best-value">
                  ...
                  <p className="mb-0">
                    Suggested for established organizations
                  </p>
                </div>
                <div className="plans-details">
                  <div className="plans-details-text">
                  ...
                  <ul className="plans-details-list">
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
                      Advanced email security &amp; retention
                    </li>
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
                      <strong>500</strong> participant video meetings +
                      attendance tracking
                    </li>
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
                      <strong>5 TB</strong> cloud storage per user
                    </li>
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
                      Endpoint management &amp; advanced compliance
                    </li>
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
                      Priority support
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
            <div className="plan-box workspace-height d-flex flex-column justify-content-between">
              <div>
                ...
                <div className="plans-details">
                  <div className="plans-details-text">
                    <h3 className="div-sub-title mb-0 weight-SemiBold">
                  ...
                  <ul className="plans-details-list">
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
                      Unlimited storage (as per policy)
                    </li>
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
                    ...
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
                      Advanced DLP, encryption &amp; access controls
                    </li>
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
                      Large meetings with live streaming
                    </li>
                    <li>
                      <FaCheckCircle className={styles.CheckIcon} />
                      Premium support &amp; account management
                    </li>
                  </ul>
                </div>
              </div>
