...
const BusinessBoost = () => {
  return (
    <section
      className="boost-business-section position-relative"
        ...
        <div className="row h-100">
          <div className="col-lg-6 col-md-12 col-12 d-flex align-items-center">
            <div className="boost-business-text">
              ...
              >
                Empower your team with smart tools, secure communication, and
                AI-driven productivity—built to help your business grow faster.
              </p>
              <ul
              ...
              >
                <li>
                  ...
                  <strong>Professional</strong> email with your business domain
                </li>
                <li>
                  <FaCheckCircle className={styles.CheckIcon} />{" "}
                  <strong>Seamless team</strong> collaboration and communication
                </li>
                <li>
                  <FaCheckCircle className={styles.CheckIcon} />{" "}
                  <strong>AI-powered</strong> tools to work smarter and faster
                </li>
                <li>
                  <FaCheckCircle className={styles.CheckIcon} />{" "}
                  <strong>Secure cloud </strong> storage and enterprise-grade
                  security
                </li>
                <li>
                  <FaCheckCircle className={styles.CheckIcon} />{" "}
                  <strong>Reliable support</strong> whenever you need it
                </li>
              </ul>
              <div className="d-flex gap-5 mt-40">
                <Link
                  href="contact"
                  className="tp-btn-black aos-init"
                  data-aos="fade-up"
                  data-aos-easing="linear"
                  data-aos-duration="600"
                >
                ...
                <Link
                  href="contact"
                  className="tp-btn-black tp-btn-white tp-btn-white2 aos-init"
                  data-aos="fade-up"
                  data-aos-easing="linear"
                  data-aos-duration="900"
                >
              ...
              <div
                className="feature-strip d-flex flex-wrap justify-content-center align-items-center gap-4 aos-init"
                data-aos="zoom-in"
                data-aos-easing="linear"
                data-aos-duration="600"
              >
