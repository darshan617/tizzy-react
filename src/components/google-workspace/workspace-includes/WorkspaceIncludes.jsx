        ...
        <div className="row">
          <div className="col-12">
            <div className="timeline">
              <span
                className="timeline-line aos-init aos-animate"
                data-aos="zoom-in"
                data-aos-easing="linear"
                data-aos-duration="600"
              ></span>
              ...
              <div className="row">
                <div className="col-lg-4 col-md-4 col-6">
                  <div
                    className="timeline-item top aos-init aos-animate"
                    data-aos="fade-up"
                    data-aos-easing="linear"
                    data-aos-duration="600"
                  >
                    ...
                    <div className="timeline-text">
                      ...
                      <p className="mb-0">
                        Store, manage, and access all your important files and
                        data with generous cloud storage—no space worries.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 col-md-4 col-6">
                  ...
                  >
                    ...
                    <div className="timeline-text">
                      ...
                      <p className="mb-0">
                        Stay productive wherever you are with Google Workspace
                        apps available on iOS, Android, and Windows devices.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-4 col-md-4 col-6 timeline-desktop-none">
                  <div
                    className="timeline-item bottom aos-init aos-animate"
                    data-aos="fade-up"
                    data-aos-easing="linear"
                  ...
                  >
                    ...
                    <div className="timeline-text">
                      ...
                      <p className="mb-0">
                        Collaborate effortlessly using Docs, Sheets, and Slides
                        with real-time editing and instant updates.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="row timeline-mobile-none">
                <div className="col-lg-4 col-md-4 col-6">
                  <div
                    className="timeline-item bottom aos-init"
                    data-aos="fade-up"
                    data-aos-easing="linear"
                    data-aos-duration="1200"
                  >
