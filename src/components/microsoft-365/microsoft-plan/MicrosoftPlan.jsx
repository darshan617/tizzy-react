...
const teamsPlans = [
  {
    ...
    highlights: [
      {
        text: "Identity and access management for up to 300 users\u200B",
        hidden: false,
      },
      {
        text: "Web and mobile versions3 of Word, Excel, PowerPoint, and Outlook\u200B",
        hidden: false,
      },
      { text: "Custom business email (you@yourbusiness.com)", hidden: false },
      {
        text: "Chat, call, and meet with Microsoft Teams\u200B",
        hidden: false,
      },
      { text: "1 TB of cloud storage per user\u200B", hidden: false },
      {
        text: "10+ additional apps for your business needs (including Microsoft Bookings, Planner, and Forms)\u200B",
        hidden: false,
      },
      {
        text: "AI chat experience with web grounding, writing assistance, data analysis, and access to agents4",
        hidden: true,
      },
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        text: "Web, mobile, and desktop versions3 of Word, Excel, PowerPoint, and Outlook\u200B",
        hidden: false,
      },
      {
        text: "Custom business email (you@yourbusiness.com)\u200B",
        hidden: false,
      },
      {
        text: "Chat, call, meet, and host webinars with Microsoft Teams\u200B",
        hidden: false,
      },
      { text: "1 TB of cloud storage per user\u200B", hidden: false },
      {
        text: "10+ additional apps for your business needs (including Microsoft Loop, Clipchamp, Bookings, Planner, and Forms)\u200B",
        hidden: false,
      },
      {
        text: "AI chat experience with web grounding, writing assistance, data analysis, and access to agents4\u200B",
  ...
  },
  {
    ...
    highlights: [
      {
        text: "Advanced identity and access management for up to 300 users",
        hidden: false,
      },
      {
        text: "Web, mobile, and desktop versions3 of Word, Excel, PowerPoint, and Outlook\u200B",
      ...
      {
        text: "Enhanced cyberthreat protection against viruses and phishing attacks\u200B",
        hidden: true,
      },
      {
        text: "Discovery, classification, and protection of sensitive data\u200B",
        hidden: true,
      },
      { text: "Anytime phone and web support\u200B", hidden: true },
    ],
...
const noTeamsPlans = [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        text: "Desktop versions of Word, Excel, PowerPoint, and Outlook",
        hidden: false,
      },
      { text: "1 TB of cloud storage per user", hidden: false },
...
const copilotWithTeamsPlans = [
  {
    ...
    tagline:
      "Powerful web, mobile, and desktop apps combined with Microsoft 365 Copilot",
    priceTag: "h6",
    price: "₹ 1,955.00",
    priceUnit: "user/month, paid yearly",
    highlights: [
      {
        text: "Microsoft 365 Copilot in apps such as Word, Excel, PowerPoint, Outlook, and Microsoft Teams5",
        hidden: false,
      },
      {
        text: "AI-powered chat connected to your work data and access to reasoning AI for research and data analysis",
        hidden: false,
      },
      {
        text: "Identity and access management for up to 300 users",
  ...
  },
  {
    ...
    badge: "Limited time discount offer*",
    tagline:
      "Everything your business needs to be more productive and secure combined with Microsoft 365 Copilot",
    priceTag: "h4",
    price: "₹ 2,660.00",
    priceUnit: "user/month, paid yearly",
    highlights: [
...
const copilotNoTeamsPlans = [
  {
    ...
    highlights: [
      {
        text: "Microsoft 365 Copilot in apps such as Word, Excel, PowerPoint, and Outlook5\u200B",
        hidden: false,
      },
      {
        text: "AI-powered chat connected to your work data and access to reasoning AI for research and data analysis",
...
const PlanCard = ({ plan }) => {
  ...
  return (
    <div
      className={plan.colClass + " aos-init aos-animate"}
      data-aos="fade-up"
      ...
      <div className="plan-box workspace-plan-box d-flex flex-column justify-content-between">
        <div>
          ...
          <div className="plans-details">
            {plan.badge && (
              <h4 className="small-text mb-0 weight-SemiBold most-popular most-popular-offer">
                {plan.badge}
              </h4>
            )}
            <div className="plans-details-text">
              ...
              <PriceTag className="div-title mb-0 weight-SemiBold">
                {plan.price}
              </PriceTag>
            ...
            <div className="">
              <div className="qty-wrapper-bg features">
                <h4 className="p-content mb-0 weight-SemiBold">
                  Plan highlights:
                </h4>
              </div>
              <div className="more-details-box">
                ...
                <div className="features-bottom">
                  <a
                    ...
                    style={
                      plan.hideSeeAllFeatures ? { display: "none" } : undefined
                    }
                  >
                    See All Features
                  </a>
        ...
        <div className="">
          <ul className="plans-apps-list">
            <li className="p-content mb-0 weight-SemiBold w-100">
              Popular apps and services included:
            </li>
            {plan.apps.map((app, i) => (
              <li key={i}>
      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-xl-7 col-lg-9 col-md-12 col-12">
            <div
              className="workspace-plan-title text-center"
              id="pricing-microsoft"
            >
              <h2
              ...
              >
                Flexible productivity, collaboration, and security tools
            ...
            <div className="tab-content monthly-yearly-tab" id="nav-tabContent">
              ...
              >
                <div className="row gx-4">
                  ...
                  <div
                    className="tab-content monthly-yearly-tab"
                    id="nav-tabContent2"
                  >
                    <div
